              ...
              Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                      colors: [Colors.yellow.shade800, Colors.red],
                ...
                child: ElevatedButton(
                    style: ButtonStyle(
                        ...
                        minimumSize: MaterialStateProperty.all(
                            Size(largeur_card, hauteur_card))),
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => planningFiebaseStorage2()));
                    },
                    child: const Text(
                      'PLANNING',
                      style: TextStyle(
